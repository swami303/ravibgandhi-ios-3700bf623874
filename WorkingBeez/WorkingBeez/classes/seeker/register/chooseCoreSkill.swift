...
class chooseCoreSkill: UIViewController,UITextFieldDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        {
            txtSearch.placeholder = "Type core skill & tap on '+' to add"
            txtSearch.placeHolderColor = API.blackColor()
            if let val = deleObj.dictOfCategories["SkillNames"]
            {
                let strTitle: String = deleObj.dictOfCategories.object(forKey: "SkillNames") as! String
                ...
                for str in arrTitle
                {
                    ...
                    {
                        arrOfSkillName.add(str)
                        arrOfSelectedCoreSkill.add(0)
        ...
        lblSelectedStep.text = String(format: "Selected core skills %d/8", arrOfSelectedCoreSkill.count)
    ...
    @IBAction func btnNext(_ sender: Any)
    {
        ...
        let strSkillName = arrOfSkillName.componentsJoined(by: ",")
        deleObj.dictOfCategories.setValue(strJobIDs, forKey: "SkillIDs")
        deleObj.dictOfCategories.setValue(strSkillName, forKey: "SkillNames")
    ...
    @IBAction func btnRemoveTagFromSelected(_ sender: Any)
    {
        ...
        //arrOfSelectedCoreSkill.removeObject(at: tag)
        //arrOfSkillName.removeObject(at: tag)
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool
    {
        ...
        if textField == txtSearch
        {
            ...
            if serachText.length == 0
            {
                ...
                arrOfCoreSkill = NSMutableArray.init(array: arrSearch)
                manageTag(arrTag: arrOfCoreSkill)
            }
            else
            {
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool
    {
        if deleObj.dictOfCategories.value(forKey: "CategoryID") as! Int == 0
        {
            ...
            let dictMutable: NSMutableDictionary = NSMutableDictionary()
            dictMutable.setValue(arrOfCoreSkill.count, forKey: "index")
            dictMutable.setValue("0", forKey: "isSelected")
            ...
            if response.object(forKey: "ReturnCode") as! String == "1"
            {
                ...
                for item in arr
                {
                    ...
                    else
                    {
                        ...
                        let str: String = self.deleObj.dictOfCategories.object(forKey: "SkillIDs") as! String
                        ...
                        if arrTitle.contains(String(format: "%d", dictMutable.object(forKey: "ID") as! Int))
                        {
                            dictMutable.setValue(i, forKey: "index")
                            dictMutable.setValue("1", forKey: "isSelected")
                            self.arrOfSelectedCoreSkill.add(dictMutable.object(forKey: "ID") ?? 0)
                            self.arrOfSkillName.add(dictMutable.object(forKey: "Name") ?? 0)
                        }
                        else
                        {
                            dictMutable.setValue(i, forKey: "index")
