...
@IBDesignable class CustomView: UIView {
    ...
    @IBInspectable var firstButtonImage: UIImage?
        {
        get {
            return btnFirstOutlet.currentImage
        }
        set(image) {
            btnFirstOutlet.setImage(image, for: UIControlState.normal)
        }
    }
...
//    }
    ...
    func xibSetup()
    {
        ...
        self.btnFirstOutlet.setImage(UIImage.init(named: img1), for: UIControlState.normal)
